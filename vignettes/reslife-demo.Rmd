...
run it through the residlife function with type = 'mean', and plot the output against time. For this example, we will use the 'weibull' distribution with shape = 2.9 and scale = 2.2. 

```{r}
time= seq(1,20)
life = residlife(values = time, distribution = 'weibull', parameters= c(shape= 2.9, scale = 2.2))
plot(time, life, xlab = 'Time', ylab = 'Mean Residual Life', main = 'MRL over Time')
```
